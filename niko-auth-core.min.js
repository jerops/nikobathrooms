// NIKO AUTH CORE - FIXED API KEY + CMS COMPATIBILITY v3.2
// This is THE auth file - no others needed!

(function(window) {
    'use strict';
    
    console.log('🚀 Loading Niko Auth Core v3.2 - FIXED API KEY + CMS COMPATIBILITY');
    
    const CONFIG = {
        SUPABASE_URL: 'https://bzjoxjqfpmjhbfijthpp.supabase.co',
        // Using the WORKING API key from auth-core/dist
    ...
    class NikoAuthCore {
        ...
        async init() {
            ...
            try {
                ...
                // Create Supabase client with CORRECT API key
        ...
        // CMS INTEGRATION COMPATIBILITY METHODS
        getSupabaseClient() {
    ...
    // Expose clean API on window with CMS compatibility
    window.NikoAuthCore = {
        // Main methods
        register: authCore.register.bind(authCore),
        login: authCore.login.bind(authCore),
        logout: authCore.logout.bind(authCore),
        getCurrentUser: authCore.getCurrentUser.bind(authCore),
        isAuthenticated: authCore.isAuthenticated.bind(authCore),
        isInitialized: authCore.isInitialized.bind(authCore),
        getDashboardUrl: authCore.getDashboardUrl.bind(authCore),
        
        // CMS Integration compatibility
        getSupabaseClient: authCore.getSupabaseClient.bind(authCore),
        getIsInitialized: authCore.getIsInitialized.bind(authCore),
        
        // Direct access to instance for debugging
        _instance: authCore
    };
    
    console.log('✅ NikoAuthCore exposed globally with CMS compatibility - ready to use!');
